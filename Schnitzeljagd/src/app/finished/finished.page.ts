...
export class FinishedPage implements OnInit {
  ...
  constructor(
    private scavengerHunt: ScavangerHuntManagerService,
    private scavengerHuntData: ScavangerHuntDataService,
  ...
  ngOnInit() {
    ...
    const currentScavengerHunt =
      this.scavengerHuntData.getHuntById(currentHuntId);
